...
{{-- 
    ...
    <div class="col-md-6">
        <label for="Tiempo" class="form-label">Califica el tiempo que consideras aplicar a tu artículo</label>
        ...
        <select class="form-select" id="Tiempo" name="Tiempo">
            <option value="" selected>-- Seleccione --</option>
            <option value="-4" @if($tema and $tema->Tiempo == -4) selected @endif>04 meses</option>
            <option value="-3" @if($tema and $tema->Tiempo == -3) selected @endif>08 meses</option>
            <option value="-2" @if($tema and $tema->Tiempo == -2) selected @endif>12 meses</option>
            <option value="-1" @if($tema and $tema->Tiempo == -1) selected @endif>16 meses</option>
            <option value="0" @if($tema and $tema->Tiempo == 0) selected @endif>20 meses</option>
            <option value="1" @if($tema and $tema->Tiempo == 1) selected @endif>24 meses</option>
            <option value="2" @if($tema and $tema->Tiempo == 2) selected @endif>28 meses</option>
            <option value="3" @if($tema and $tema->Tiempo == 3) selected @endif>32 meses</option>
            <option value="4" @if($tema and $tema->Tiempo == 4) selected @endif>36 meses</option>
        </select>
    </div>

    <div class="col-md-6">
        <label for="Requerimientos" class="form-label">Califica el acceso a requerimientos materiales - presupuesto que consideras tendrá tu artículo</label>
        ...
        <select class="form-select" id="Requerimientos" name="Requerimientos">
            <option value="" selected>-- Seleccione --</option>
            <option value="-4" @if($tema and $tema->Requerimientos == -4) selected @endif>0% de lo mínimo que necesita</option>
            <option value="-3" @if($tema and $tema->Requerimientos == -3) selected @endif>25% de lo mínimo que se necesita</option>
            <option value="-2" @if($tema and $tema->Requerimientos == -2) selected @endif>50% de lo mínimo que se necesita</option>
            <option value="-1" @if($tema and $tema->Requerimientos == -1) selected @endif>75% de lo mínimo que se necesita</option>
            <option value="0" @if($tema and $tema->Requerimientos == 0) selected @endif>100% de lo mínimo que se necesita</option>
            ...
            <option value="2" @if($tema and $tema->Requerimientos == 2) selected @endif>150% de lo mínimo que se necesita</option>
            <option value="3" @if($tema and $tema->Requerimientos == 3) selected @endif>175% de lo mínimo que se necesita</option>
            <option value="4" @if($tema and $tema->Requerimientos == 4) selected @endif>200% de lo mínimo que necesita</option>
        </select>
